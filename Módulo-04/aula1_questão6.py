...
print (f"A porcentagem de coelhos usados é de: {soma_coelho/n}%")
print (f"A porcentagem de ratos usados é de: {soma_rato/n}%")
print (f"A porcentagem de sapos usados é de: {soma_sapo/n}%")
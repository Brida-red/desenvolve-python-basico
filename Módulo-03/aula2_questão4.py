...
mago = classe == 'mago'; pontos_força <= 10 and pontos_magia >= 15
guerreiro = classe == 'guerreiro'; pontos_força >= 15 and pontos_magia <= 10
arqueiro = classe == 'arqueiro'; (pontos_força > 5) and (pontos_magia > 5) and (pontos_força <= 15) and (pontos_magia <= 15)
